...
CONFIG = {
    "pydantic_validators": ["pydantic_validators.models:manager1", "pydantic_validators.models:manager2"],
...
@pytest.mark.parametrize(
    "schema", ["Hostname", "Interfaces", "pydantic/Hostname", "pydantic/Interfaces", "pydantic/Dns"]
)
